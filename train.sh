...
--resume \
--exp_id ${TILE_SIZE} \
--config-file /home/mrajaraman/master-thesis-dragonfly/mask-DINO/MaskDINO-MassID45/configs/lifeplan/instance-segmentation/maskdino_R50_bs16_50ep_3s_dowsample1_2048.yaml \
